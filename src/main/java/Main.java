...
public class Main {
    ...
    private static final String CLIENT_SERVER_URI = "ws://localhost:8080/ChinchiroServer/ws";
    private static final String APP_SERVER_URI    = "ws://localhost:8082/GameServer/game";
